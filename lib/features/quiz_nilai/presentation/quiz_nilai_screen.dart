    ...
    return Scaffold(
      ...
      body: BlocConsumer<QuizNilaiBloc, QuizNilaiState>(
        ...
        builder: (context, state) {
          if (state is QuizNilaiInitial) context.read<QuizNilaiBloc>().add(GetNilaiQuizEvent(category));
          return switch (state) {
